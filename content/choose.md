...
- [**Node.js / Javascript**](https://www.howtographql.com/graphql-js/1-getting-started/) (_Beginners Choice_): This tutorial uses the [graphql-js](https://github.com/graphql/graphql-js) reference implementation. You'll build a GraphQL server using [Node.js](https://nodejs.org/en/), the [graphql-yoga](https://github.com/graphcool/graphql-yoga) server library and [Prisma](https://www.prisma.io).
- [**Node.js / Typescript**](https://www.howtographql.com/graphql-ts/1-getting-started/) (_Beginners Choice_): This tutorial uses the [graphql-js](https://github.com/graphql/graphql-js) reference implementation. You'll build a GraphQL server using [Node.js](https://nodejs.org/en/), [Fastify](https://github.com/fastify/fastify) the [graphql-helix](https://github.com/contrawork/graphql-helix) server library, [Envelop](https://github.com/dotansimha/envelop) and [Prisma](https://www.prisma.io).
